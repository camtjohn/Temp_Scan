...
// Convert hex bytes to ascii letters
...
// When advertised device name is x, print device name: ascii_packet_value
class AdvertisedDeviceCallbacks: public BLEAdvertisedDeviceCallbacks {
  void onResult(BLEAdvertisedDevice advertisedDevice) {
    if (strcmp(advertisedDevice.getName().c_str(), "sensor1") == 0) {
